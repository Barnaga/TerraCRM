...
constexpr auto qt_meta_stringdata_CLASScreateProjectDialogENDCLASS = QtMocHelpers::stringData(
    "createProjectDialog",
    "create",
    "",
    "createContactBox",
...
void createProjectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->createContactBox((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
