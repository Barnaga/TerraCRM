...
constexpr auto qt_meta_stringdata_CLASSProjectWindowENDCLASS = QtMocHelpers::stringData(
    "ProjectWindow",
    "openProject",
    "",
    "QModelIndex",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSProjectWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ProjectWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSProjectWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSProjectWindowENDCLASS,
    qt_static_metacall,
    nullptr,
...
void ProjectWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->openProject((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
...
void *ProjectWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSProjectWindowENDCLASS.stringdata0))
